...
describe 'Forecast' do
  describe '#points' do
    ...
    #crear un forecast
    forecast_1 =  Forecast.new(result: 'HOME', goals_home: 2, goals_away: 1, match: match_1, tournament: tournament_1)
    
    describe "when match doesn't have result" do
      it 'should return 0' do
        expect(forecast_1.calculate_points).to eq(0)
      end
    end
    ...
    describe 'when forecast is totally correct' do
      it 'should return 3' do
        match_1.result = 'HOME'
        match_1.goals_home = 2
        match_1.goals_away = 1
  
        expect(forecast_1.calculate_points).to eq(3)
      end
    end
    ...
    describe 'when forecast is parcially correct' do
      it 'should return 1' do
        match_1.result = 'HOME'
        match_1.goals_home = 3
        match_1.goals_away = 2
  
        expect(forecast_1.calculate_points).to eq(1)
      end
    end
